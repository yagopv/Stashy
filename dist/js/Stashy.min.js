...
a.gesture.stopDetect()}};d.prototype.layout=function(){if(null!=this.element){b("html").addClass("js");this.element.find(".st-flyout-toggle").on("click",function(a){b(this).closest(".st-flyout-container").toggleClass("active-menu");a.stopPropagation();return!1});"reveal"==this.options.slideType?this.element.find(".st-flyout-container").addClass("st-reveal"):this.element.find(".st-flyout-container").addClass("st-push");Modernizr&&Modernizr.csstransforms3d&&this.element.find(".st-flyout-container").addClass("active-transforms");
if(this.options.closeOnClickOutside){var c=this;this.element.on("click",function(){c.close()})}this.options.enableTouch&&("function"==typeof Hammer&&Modernizr.touch)&&(this.element.hammer({drag_lock_to_axis:!0}),this.element.on("swipeleft swiperight",{flyout:this},a));this.enabled=!0;return this}};d.prototype.open=function(){null!=this.element&&this.container.addClass("active-menu")};d.prototype.close=function(){null!=this.element&&this.container.removeClass("active-menu")};g.Flyout=function(a,b){return new d(a,
